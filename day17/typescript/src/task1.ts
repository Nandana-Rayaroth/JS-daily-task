...
let TestCase = [
  ...
  },
  {
    id: 3,
    InputArray: [1, 2, 3, 4],
    InputFunction: (x: number) => x === 2,
    output: [[2], [1, 3, 4]],
  },
  {
    id: 4,
    InputArray: [12, 89, 42, 58, 36],
    InputFunction: (x: number) => x === 0,
  ...
  },
  {
    ...
    InputFunction: (x: string) => typeof x === "string",
    output: [
      ["34", "56", "90"],
      [12, 23],
    ],
  },
  {
    ...
    InputFunction: (x: number) => typeof x === "object",
    output: [
  ...
  },
  {
    ...
    InputFunction: (x: number) => typeof x === "number",
