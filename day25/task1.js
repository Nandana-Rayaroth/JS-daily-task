    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 5, , 6]);
                    return [4 /*yield*/, fetch("https://jsonplaceholder.typicode.com/posts?_".concat(pageParam, "&_limit=10"))];
                case 1:
                    response = _a.sent();
                ...
                case 3:
                    ...
                    result.forEach(function (data) {
                        var dataId = document.createElement("li");
                        dataId.textContent = data.id;
                        var dataTitle = document.createElement("p");
                        dataTitle.textContent = data.title;
                        dataId.appendChild(dataTitle);
                        var dataBody = document.createElement("p");
                        dataBody.textContent = data.body;
                        dataId.appendChild(dataBody);
                        items.appendChild(dataId);
                    });
